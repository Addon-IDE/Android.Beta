...
public class SchemeVS2019 extends EditorColorScheme {
    ...
    public void applyDefault() {
        ...
        setColor(HTML_TAG, 0xFFE06C75);
        setColor(ATTRIBUTE_NAME, 0xFFD19A66);
        setColor(ATTRIBUTE_VALUE, 0xFF98C379);
        setColor(TEXT_INLAY_HINT_FOREGROUND, 0xFF98C379);
        
        setColor(SNIPPET_BACKGROUND_EDITING, 0xFF3E4451);
        setColor(SNIPPET_BACKGROUND_INACTIVE, 0xFF3E4451);
        setColor(SNIPPET_BACKGROUND_RELATED, 0xFF3E4451);
    }
